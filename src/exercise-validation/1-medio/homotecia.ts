/**
 * Validación de ejercicios: homotecia
 * Curso: 1-medio
 * 
 * Este archivo contiene las reglas de validación y retroalimentación
 * para los ejercicios de homotecia.
 */
...
export const homoteciaValidation: ExerciseValidation[] = [
];

export default homoteciaValidation;
