...
import { interpretGeoGebraCommand } from '../geogebra-ai-actions';
...
export default function GeoGebraAIPage() {
    ...
    useEffect(() => {
        const handleMouseMove = (e: MouseEvent) => {
            ...
            const maxX = window.innerWidth - 56; // 56px = ancho del botón
