                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {(profile?.role === 'teacher' || profile?.role === 'student' || profile?.role === 'admin') && (
                        <Link href="/aulas" className="md:col-span-2">
                            <Button
                                variant="default"
                                className={`w-full justify-start ${profile?.role === 'teacher'
                            ...
                            >
                                ...
                                {profile?.role === 'teacher' && 'Mis Aulas - Gestión de Clases'}
                                {profile?.role === 'student' && 'Mis Aulas - Clases Inscritas'}
                                {profile?.role === 'admin' && 'Todas las Aulas - Vista Admin'}
                            </Button>
                        </Link>
                    )}
