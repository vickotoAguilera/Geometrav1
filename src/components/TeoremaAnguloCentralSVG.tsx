...
export function TeoremaAnguloCentralSVG(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path d="M 60 60 Q 68 52, 75 56" fill="none" stroke="hsl(var(--primary))" strokeWidth="0.8" />
      <text x="68" y="50" fontSize="8" fill="hsl(var(--primary))" fontWeight="bold">2α</text>

      {/* Inscribed Angle (alpha) */}
      <path d="M 21.6 30.5 L 60 110 L 98.4 30.5" fill="none" stroke="hsl(var(--foreground))" strokeWidth="1" />
      <path d="M 60 110 Q 60 102, 65 102" fill="none" stroke="hsl(var(--foreground))" strokeWidth="0.8" transform="translate(-8, -10) rotate(22, 60, 110)"/>
