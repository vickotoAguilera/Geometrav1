                        ...
                        {ejercicios.map(courseData => (
                           <TabsContent key={courseData.course} value={courseData.course}>
                             <div className="space-y-2 pt-4">
                                ...
                                {courseData.course === 'segundo-medio' && (
                                   <a href="https://drive.google.com/drive/folders/1GGvHUdlkzUirhC7JyQaGxcV16MmnO_AO?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full">
                                        <Button variant="outline" className="w-full justify-start gap-2">
                                            <Download className="w-4 h-4" />
                                            Descargar material de estudio
                                        </Button>
                                ...
                                {courseData.course === 'tercero-medio' && (
                                    <a href="https://drive.google.com/drive/folders/1TwIShZOsp3NJ9oVuVppaVqx5yrnu4N3I?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full">
                                        <Button variant="outline" className="w-full justify-start gap-2">
                                            <Download className="w-4 h-4" />
                                            Descargar material de estudio
                                        </Button>
                                ...
                                {courseData.course === 'cuarto-medio' && (
                                    <a href="https://drive.google.com/drive/folders/1IdnO0j_h3uEHF8GEurBlCBM1DeHhbW1w?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full">
                                        <Button variant="outline" className="w-full justify-start gap-2">
                                            <Download className="w-4 h-4" />
                                            Descargar material de estudio
                                        </Button>
