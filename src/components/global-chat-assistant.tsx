...
// Define el tipo para los mensajes de la conversación
  ...
  return (
    <div className="text-sm p-3 rounded-lg bg-secondary text-secondary-foreground w-full space-y-3">
      <p className="font-medium">
        ¡Hola! Soy Geometra, tu tutor de IA.
      </p>
      <p>
        Puedes hacerme cualquier pregunta de matemáticas o GeoGebra. Tu historial de chat se guardará.
      </p>
    </div>
  );
};
...
export function GlobalChatAssistant() {
  ...
  const handleResetChat = () => {
    // Here you would also clear the history in Firestore if it was implemented
    setMessages([]);
  };
      ...
      <SheetHeader className="p-4 border-b">
        ...
        <AlertDialog>
            <AlertDialogTrigger asChild>
                <Button variant="ghost" size="icon" className="absolute top-3 right-3 h-8 w-8" title="Reiniciar chat">
            ...
            <AlertDialogContent>
                ...
                <AlertDialogDescription>
                    Esta acción borrará la conversación actual de esta ventana. El historial guardado no se verá afectado.
                </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <SheetFooter className="p-4 border-t bg-background">
          ...
          >
            <Input
              ...
              placeholder="Pregúntale a Geometra..."
              disabled={isPending}
            />
