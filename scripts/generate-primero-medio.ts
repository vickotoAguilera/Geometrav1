...
/**
 * Generación completa de pools para 1° Medio
 */
...
async function generatePrimeroMedio() {
    console.log('\n' + '='.repeat(70));
    console.log('🔄 GENERACIÓN DE POOLS - 1° MEDIO');
    console.log('='.repeat(70) + '\n');
    ...
    console.log(`📦 Total pools: ${completed.size + completedNow}/${primeroMedio.subjects.length}`);
    console.log('='.repeat(70) + '\n');
}
