...
# Script para ver el estado y progreso de la generación
...
clear
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   📊 ESTADO GENERACIÓN 2° MEDIO                               ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
if [ ! -f "$PID_FILE" ]; then
    ...
    echo "   Usa './start-segundo-medio.sh' para iniciar"
    exit 1
fi
...
TOTAL=7  # Total de materias en 2° Medio
...
echo "   - Actualizar:        ./status-segundo-medio.sh"
echo ""
