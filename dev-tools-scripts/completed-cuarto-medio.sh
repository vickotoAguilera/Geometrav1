...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   ✅ POOLS COMPLETADOS - 4° MEDIO                            ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
if [ -f "$PROJECT_DIR/scripts/check-r2-pools.ts" ]; then
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    cd "$PROJECT_DIR"
    npx tsx scripts/check-r2-pools.ts 2>/dev/null | grep -A 20 "cuarto-medio" || echo "   (No disponible)"
    echo ""
fi

echo "💡 Comandos:"
echo "   - Ver log completo:  cat $LOG_FILE"
echo "   - Ver estado:        ./status-cuarto-medio.sh"
echo ""
