...
echo "╔════════════════════════════════════════════════════════════════╗"
echo "║   ✅ POOLS COMPLETADOS - 3° MEDIO                            ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
if [ -f "$PROJECT_DIR/scripts/check-r2-pools.ts" ]; then
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    cd "$PROJECT_DIR"
    npx tsx scripts/check-r2-pools.ts 2>/dev/null | grep -A 20 "tercero-medio" || echo "   (No disponible)"
    echo ""
fi

echo "💡 Comandos:"
echo "   - Ver log completo:  cat $LOG_FILE"
echo "   - Ver estado:        ./status-tercero-medio.sh"
echo ""
